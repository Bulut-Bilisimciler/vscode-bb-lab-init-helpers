...
export function activate(context: vscode.ExtensionContext) {
  ...
  console.log(
    'Congratulations, your extension "Bulut-Bilisimciler.vscode-bb-lab-init-helpers" is now active!'
  );
  ...
  // I dont want to use vscode terminal.
  vscode.window.onDidOpenTerminal((terminal) => {
    terminal.dispose();
    console.log("🛑 Terminal forbidden. pid:" + terminal.processId);

    // show information dialog
    vscode.window
      .showErrorMessage("Terminal is disabled.")
      .then((selection) => {
        console.log("User selection: " + selection);
      });
  });

  // prevent "New Terminal" command
}
